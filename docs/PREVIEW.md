...
This command requires authentication to access your Zid store account and development stores. If you're not already logged in, you'll be prompted to do so.
...
2. Ensure you're authenticated by running `zidify login` first.
